...
export const Contact: React.FC<ContactProps> = ({ onOpenResume }) => {
  ...
  try {
const response = await fetch('https://formspree.io/f/mdenwlon', {
  method: 'POST',
  headers: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-7 text-left">
              ...
              <p className="text-base sm:text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed mb-8 max-w-xl">
                Have a website, product or creative idea in mind? Let's turn
                your idea into a modern and engaging digital experience.
              </p>
              ...
              <div className="p-6 sm:p-7 rounded-2xl bg-white dark:bg-[#161616] border border-neutral-200 dark:border-neutral-800 shadow-lg mb-8">
                ...
                {formStatus === 'success' && (
                  <div className="p-6 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-center">
                    ...
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 mt-1">
                      Thank you! Your project inquiry has been received. Pooja
                ...
                {/* ERROR */}
                {formStatus === 'error' && (
                  <div className="p-4 mb-4 rounded-xl bg-red-500/10 border border-red-500/30 text-red-500 text-sm">
                ...
                {formStatus !== 'success' && (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-60 text-white text-xs sm:text-sm font-bold shadow-md shadow-[#2563eb]/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                    >
              ...
              <div className="pt-6 border-t border-neutral-200 dark:border-neutral-800/80 flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="p-2.5 rounded-xl bg-white dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300 hover:text-white hover:bg-[#2563eb] border border-neutral-200 dark:border-neutral-800 transition-all"
                  >
